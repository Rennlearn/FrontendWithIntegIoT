...
export default function AlarmModal({ visible, container, time, remainingAlarms = 0, isScheduled = false, onDismiss, onStopImmediate, onStop, externalVerification }: Props) {
